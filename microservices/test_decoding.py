...
def test_basic_functionality():
    ...
    # Use expected tensor from workflow_script_serial_test.py (check multiple paths)
    ...
    test_latent = find_test_file("sampling_output.pt")
    ...
    expected_tensor_paths = [
        Path("test_outputs/decoding_output.pt"),
        Path("../test_outputs/decoding_output.pt"),
        Path(__file__).parent.parent / "test_outputs" / "decoding_output.pt"
    ]
